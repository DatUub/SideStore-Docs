...
Currently, this method is only available for macOS. To install via Windows, or if this method is not working, see the next section. Before you start, make sure to [setup WireGuard](install.md#Setting-up-WireGuard) and is within the [install requirements](install.md#Install-Requirements)!
...
Please note that if you use this method, you will have to generate a [pairing file](install.md#pairing-file) yourself. As well, make sure that the non-Microsoft Store versions of [iCloud](https://updates.cdn-apple.com/2020/windows/001-39935-20200911-1A70AA56-F448-11EA-8CC0-99D41950005E/iCloudSetup.exe) and [iTunes](https://support.apple.com/en-us/HT210384) are installed, if you are running Windows. Before you start, make sure to [setup WireGuard](install.md#Setting-up-WireGuard) and is within the [install requirements](install.md#Install-Requirements)!
...
To install SideStore (or any other IPA) on Linux, make sure you have docker and docker-compose installed. Before you start, make sure to [setup WireGuard](install.md#Setting-up-WireGuard) and is within the [install requirements](install.md#Install-Requirements)!
